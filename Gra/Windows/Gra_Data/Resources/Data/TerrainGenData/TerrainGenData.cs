...
namespace RacingGameBot.Data {
    public enum TerrainType { Forest, Desert, Mountains }
    ...
    public class TerrainGenData : UpdatableData {
        ...
        [Range(0f, 0.2f)] public float terrainDetailsMain = 0.1f;
        ...
        [Range(0.1f, 5f)] public float terrainScaleMinor = 2f;
        [Range(0.1f, 5f)] public float terrainScaleTiny = 1f;
