...
namespace RacingGameBot.Utils {
    public static class Bezier {
        ...
        public static Terrains.OrientedPoint GetBezierOrientedPoint(Vector3 a, Vector3 b, Vector3 c, Vector3 d, float t) {
            ...
            return new Terrains.OrientedPoint(pos, tan);
        }
        ...
        public static Terrains.OrientedPoint GetNearestBezierPointOld(Vector3 bezierA, Vector3 bezierB, Vector3 bezierC, Vector3 bezierD, Vector3 target) {
            ...
            return new Terrains.OrientedPoint(closestPoint.position, closestPoint.rotation, Mathf.Sqrt(minDistance));
        }
        ...
        /// <param name="target">From what point to calculate distance</param>
        /// <returns>OrientedPoint with position, rotation and distance</returns>
        public static Terrains.OrientedPoint GetNearestBezierPoint(Vector3 bezierA, Vector3 bezierB, Vector3 bezierC, Vector3 bezierD, Vector3 target) {
