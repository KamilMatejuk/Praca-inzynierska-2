...
namespace RacingGameBot.Utils {
    public static class Parser {
        ...
        public static Terrains.OrientedPoint OrientedPointParse(string sOP) {
            if (sOP.StartsWith("OP(pos: ") && sOP.EndsWith(")")) {
                ...
                return new Terrains.OrientedPoint(Vector3Parse(sPosition), QuaternionParse(sRotation));
            }
            return new Terrains.OrientedPoint(Vector3.zero);
        }
